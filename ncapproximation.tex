...
\subsection{Relations among classes of optimization problems}
...
Although \textsc{Linear Programming} is hard to approximate in parallel, if we restrict the input to only positive matrices, the problem becomes much easier: \textsc{Positive Linear Programming} has an \NC{} approximation scheme \cite{tx98}.
\begin{openquestion}
  Is there a restriction of \textsc{Linear Programming} weaker than the restriction of positivity that permits a constant-factor \NC{} approximation?
\end{openquestion}
