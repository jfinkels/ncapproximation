%% ncapproximation.tex - parallel approximations for sequential problems
%%
...
\hypersetup{pdftitle={Highly parallel approximations for inherently sequential problems}, pdfauthor={Jeffrey Finkelstein}}
