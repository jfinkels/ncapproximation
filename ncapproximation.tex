...
\begin{proof}
  ...
  \begin{align*}
    I & = \{(A, \mathbf{b}, \mathbf{c}) \, | \, A \in \mathbb{Z}^{m \times n}, \mathbf{b} \in \mathbb{Z}^m, \mathbf{c} \in \mathbb{Z}^n \} \\
    S & = \{((A, \mathbf{b}, \mathbf{c}), \mathbf{x}) \, | \, \mathbf{x} \in \mathbb{Z}^n \text{ and } A\mathbf{x} \leq \mathbf{b}\} \\
